...
public interface CalcModel {
	...
	/**
	 * Zamrzavanje predane vrijednosti.
	 * 
	 * @param value vrijednost koju treba pohraniti kao zamrznutu vrijednost
	 * @throws NullPointerException ako je za <code>value</code> predana vrijednost <code>null</code>
	 */
	void freezeValue(String value);
	
	/**
	 * Provjera je li pohranjena zamrznuta vrijednost
	 * 
	 * @return <code>true</code> ako zamrznuta vrijednost nije <code>null</code>, <code>false</code> inače
	 */
